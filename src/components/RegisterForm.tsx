        ...
        <div className='flex space-x-2'>
          ...
          <div className='w-3/4 relative rounded-md'>
            ...
            <input
              type='tel'
              id='whatsapp'
              className={`w-full ${country === 'HN' ? 'pl-12' : 'pl-8'} px-4 py-2 border ${errors.whatsapp ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors`}
